...
<div class="p-4 bg-white rounded-lg shadow-sm xl:p-8">
    <div class="space-y-3 sm:flex sm:items-start sm:space-y-0 sm:justify-between">
        <h2 class="text-lg font-medium text-gray-700 capitalize sm:text-xl md:text-2xl">Salles</h2>
        ...
        <div x-data="{ modelOpen: false }">
            ...
            <button
                ...
                <span class="mx-1.5">Ajouter Salle</span>
            </button>
                ...
                <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <h1 class="text-xl font-medium text-gray-800">Ajouter un Salle</h1>
                            <button
                                    @click="modelOpen = false"
                        ...
                        <p class="text-sm text-gray-500 mb-6">
                            Remplissez les informations ci-dessous pour ajouter un nouveau salle au système.
                        </p>
                        ...
                        <form class="space-y-4" method="post" action="${pageContext.request.contextPath}/admin/departements">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Nom du Salle</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Capacite du Salle</label>
                                <input name="capacite" type="text" placeholder="capacite " required
                                       class="w-full mt-1 px-3 py-2 border rounded-md text-gray-700 placeholder-gray-400 focus:border-indigo-400 focus:ring focus:ring-indigo-300 focus:ring-opacity-40 outline-none">
                            </div>
